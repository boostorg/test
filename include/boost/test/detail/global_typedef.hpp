...
#define BOOST_TEST_STRINGIZE_CSTRING( s )   BOOST_TEST_L( BOOST_TEST_STRINGIZE( s ) )
...
static BOOST_TEST_JOIN( inst, _t)& inst BOOST_TEST_ATTRIBUTE_UNUSED = BOOST_TEST_JOIN (inst, _t)::instance();

#else

#define BOOST_TEST_SINGLETON_INST( inst ) \
namespace { BOOST_TEST_JOIN( inst, _t)& inst BOOST_TEST_ATTRIBUTE_UNUSED = BOOST_TEST_JOIN( inst, _t)::instance(); }
