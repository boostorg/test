  ...
  namespace junit_impl {
    ...
    struct junit_log_helper
    {
      struct assertion_entry {
        ...
        std::string failure_file;  // file of the assertion
      ...
      // list of failure and messages (assertions message and the full log)
      std::vector< assertion_entry > failures;
      std::vector< assertion_entry > errors;
...
private:
    ...
    bool m_is_last_failure_or_error; // true if failure, false if error
