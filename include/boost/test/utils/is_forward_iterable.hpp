...
template<typename T>
struct is_forward_iterable : public bt_false_type {};
...
struct is_forward_iterable< T [N] > : public bt_true_type {};

template<typename T, typename A>
struct is_forward_iterable< std::vector<T, A> > : public bt_true_type {};

template<typename T, typename A>
struct is_forward_iterable< std::list<T, A> > : public bt_true_type {};

template<typename K, typename V, typename C, typename A>
struct is_forward_iterable< std::map<K, V, C, A> > : public bt_true_type {};

template<typename K, typename C, typename A>
struct is_forward_iterable< std::set<K, C, A> > : public bt_true_type {};

// string is also forward iterable, even if sometimes we want to treat the
// assertions differently.
template<>
struct is_forward_iterable< std::string > : public bt_true_type {};
...
// SFINAE helper
template<typename T>
struct is_present : public bt_true_type {};
...
struct is_forward_iterable {
    ...
    typedef bt_bool<is_fwd_it_t::value> type;
