...
{
    std::pair<cstring::iterator,std::string::const_iterator> mm_pos;
...
string_name_policy::conflict_with( identification_policy const& id ) const
{
    if( id.p_type_id == p_type_id ) {
        ...
        std::pair<std::string::const_iterator,std::string::const_iterator> mm_pos =
