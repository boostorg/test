...
case execution monitor, reported by the _Unit Test Framework_ and testing proceeds to the next test case. Later on you are going
...
The _Unit Test Framework_ requires the test tree to contain at least one test suite with at least one test case. The top level
...
* The _Unit Test Framework_ initialization
...
This is the report produced by the _Unit Test Framework_ after the testing is completed, that indicates which test cases/test
