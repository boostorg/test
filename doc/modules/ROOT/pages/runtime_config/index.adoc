...
All information about the currently supported parameters of the {utf} is summarized in
the xref:runtime_config/summary.adoc[summary section].

== Test filtering

The {utf} provides an extensive filtering facility making it easy to run a specific test or a subset of tests. The
...
(eg. {decorator_disabled}, {decorator_precondition}) can be used to set the default run status of a test case.
...
ways on how to integrate this logic in the {utf} and this is explained in details in the section
