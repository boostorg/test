...
:page-aliases: boost_test/usage_recommendations/tutorials/bt_and_tdd.adoc
...
[source,cpp]
----
include::example$snippets/snippet13.cpp[tag=snippet13]
----
...
[source,cpp]
----
include::example$snippets/snippet14.cpp[tag=snippet14]
----
...
[source,cpp]
----
include::example$snippets/snippet15.cpp[tag=snippet15]
----
...
[source,cpp]
----
include::example$snippets/snippet16.cpp[tag=snippet16]
----
...
[source,cpp]
----
include::example$snippets/snippet17.cpp[tag=snippet17]
----
