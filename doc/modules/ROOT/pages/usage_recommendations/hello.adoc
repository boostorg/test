...
The {utf} solves all these issues. To integrate with it above program needs to be changed to:
...
{boost_test} tool, would you choose to see it. Is there any other ways to perform checks? The following example test
