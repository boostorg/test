...
Contexts are a facility provided by the {utf} in order to be able to trace the location of assertions better. To grasp
...
where we would like this information be persistent for the current scope. {utf} provides two tools to achieve this:
