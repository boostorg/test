...
information in the assertion, which can be achieved for instance the following way // FIXME(qbk2adoc): unresolved link boost_test.testing_tools.reports.custom_messages:
