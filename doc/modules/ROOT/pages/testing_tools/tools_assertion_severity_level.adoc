...
* xref:utf_reference/testing_tool_ref.adoc#assertion_boost_level_throw[`BOOST_REQUIRE_THROW`], {boost_test_require}
* `BOOST_CHECK_THROW`, `BOOST_TEST` footnote:[{boost_test} is equivalent to `BOOST_TEST_CHECK`]
