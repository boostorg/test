...
:page-aliases: boost_test/testing_tools/extended_comparison/floating_point.adoc
...
relational operators // FIXME(qbk2adoc): unresolved link boost_test.testing_tools.extended_comparison.floating_point.floating_points_comparison_impl.tolerance_in_operator
