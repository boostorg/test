...
* For long term usage users of the _Unit Test Framework_ should be able to build it as a standalone library.

The _Unit Test Framework_ satisfies the requirements above, and provides versatile facilities to:
